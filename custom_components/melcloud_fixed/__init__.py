...
async def copy_icons(hass: HomeAssistant) -> None:
    """Copy icon files to www folder for potential future use."""
    ...
    try:
        ...
        # Copy icon files for future custom icon solutions
        ...
        for icon_file in icon_files:
            ...
            if source_icon.exists():
                ...
                if not dest_icon.exists() or source_icon.stat().st_mtime > dest_icon.stat().st_mtime:
                    ...
                    _LOGGER.info(f"Copied {icon_file} to www folder for future use")
                    
    except Exception as e:
        _LOGGER.debug(f"Could not copy icons: {e}")
