...
# Default vane positions als fallback
...
class AtaDeviceClimate(MelCloudClimate):
    ...
    def __init__(self, device: MelCloudDevice, ata_device: AtaDevice) -> None:
        ...
        # Bepaal supported features dynamisch
        ...
        # Voeg swing features altijd toe
        self._attr_supported_features |= ClimateEntityFeature.SWING_MODE
        
        # Check voor horizontale swing ondersteuning
        if (hasattr(self._device, 'vane_horizontal') and 
            self._device.vane_horizontal is not None):
